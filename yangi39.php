...
ob_start();
define("uzfox","1390779381:AAH7kGxH0JNQT7HIVrfbmriJEFOlUZqy2MI");
$admin = "1192485657";
$botname = "merlen_robot";
...
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/joinchat/AAAAAFOOJ6a5KupAEIE5XA"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/joinchat/AAAAAEo3FBMuqg6MMBcnpg"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/joinchat/AAAAAEZtNqcNVwv1R62nDQ"],],
...
sleep(2);
     if(file_exists("uzfox/".$id.".referalid")){
           ...
           if($get=="true"){
            ...
            $user = file_get_contents("uyzfox/".$file.".pul");
            $user = $user - $minimal;
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/kochabolasi21"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/saytlardan_pul_ishlaymiz"],],
]
]),
]);
}
...
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"Nima haqida yozmoqchisiz? 😊\n\n<b>📞 Aloqa markazi:</b> @kochabolasi21",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/kochabolasi21"],],
]
]),
]);
}
...
uzfox("sendPhoto",[
"chat_id"=>$chatid,
"photo"=>"https://t.me/kochabolasi/1559",
"caption"=>"<b>Bot dasturchisi:</b> <a href='tg://user?id=1192485657'>uzfox</a>\n\n<b>Ish vaqti: 07:00 dan 23:00 gacha</b>\n\n<b>Diqqat! Bot pul to'lab berish yoki to'lab bermasligiga biz kafolat beramiz!</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"♻️ Bogʻlanish","url"=>"https://t.me/kochabolasi21"],],
]
]),
]);
}
